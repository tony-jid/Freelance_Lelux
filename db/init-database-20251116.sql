...
CREATE TABLE `massage_record` (
  ...
  `massage_record_is_banktransfer` tinyint(1) NOT NULL DEFAULT '0',
...
CREATE TABLE `therapist` (
  ...
  `therapist_hour_rate` decimal(10,0) NOT NULL DEFAULT '37'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
ALTER TABLE `health_fund`
  MODIFY `health_fund_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `massage_type`
  MODIFY `massage_type_id` int(11) NOT NULL AUTO_INCREMENT;
